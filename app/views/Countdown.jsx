...
const timers = [...Array(3).keys()].map((i) => (i === 0 ? 1 : i * 5));
    ...
    <View style={styles.container}>
      ...
      <Animated.View
        ...
        <TouchableOpacity
          onPress={animation}>
          <View
            style={[styles.roundButton, {alignItems: 'center', alignSelf:'center', justifyContent: 'center'}]}>
            <Text style={{color: colors.text}}>Get Ready!</Text>
          </View>
        </TouchableOpacity>
      </Animated.View>
      <View
